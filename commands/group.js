...
export async function antilink(client, message) {
    ...
    try {
        ...
        if (!action) {
            const usage = `🔒 *Sasori Ghost- Antilink*\n\n.antilink on\n.antilink off\n.antilink set delete | kick | warn\n.antilink status`
...
export async function kickall(client, message) {
    ...
    try {
        ...
        await client.sendMessage(groupId, { text: '☠️ Sasori Ghost- Purge...' })
...
export async function kickall2(client, message) {
    ...
    try {
        ...
        await client.sendMessage(groupId, { text: '☠️ Sasori Ghost- One Shot...' })
